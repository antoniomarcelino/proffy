...
function TeacherForm(){
    ...
    return(
        ...
        description="O primeiro passo é fácil!"/>
        ...
        <main>
            ...
            <fieldset>
                ...
                value={avatar} onChange={(e)=> {setAvatar(e.target.value)}}></Field>
                <Field name="whatsapp" label="Whatsapp"
                value={whatsapp} onChange={(e)=> {setWhatsapp(e.target.value)}}></Field>
            ...
            <fieldset>
                ...
                ></Select>
                <Field name="cost" label="Custo por hora"
                value={cost} onChange={(e) => {setCost(e.target.value)}}></Field>
           ...
           <fieldset>
              ...
              {scheduleItems.map((scheduleItem, index) => {
                  return(
                   ...
                   <Field name="from" label="Das" type="time"  value={scheduleItem.from}
                   onChange = {e=>setScheduleItemValue(index, 'from', e.target.value)} />
                   <Field name="to" label="Até" type="time"  value={scheduleItem.to}
